...
python3 main_vqvae.py --dataset mpi_real --epochs 200 --model vqvae --data-dir /g/data/po67/anonymous_cat/Data/ > /g/data/po67/anonymous_cat/Trained/logs/job2_output.log
